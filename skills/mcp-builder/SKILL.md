---
name: mcp-builder
description: 构建MCP服务器时自动触发 - 构建MCP、创建MCP、MCP服务器、Model Context Protocol、MCP SDK、FastMCP。创建高质量 MCP 服务器的指南，支持 Python (FastMCP) 和 Node/TypeScript (MCP SDK)。
version: 1.0.0
created_at: 2025-01-24
updated_at: 2026-01-26
entry_point: scripts/guide.md
