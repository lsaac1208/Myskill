...
description: GitHub仓库转Skill时自动触发 - github转skill、创建skill、打包skill、仓库转skill、github仓库。自动将 GitHub 仓库转换为专用 AI Skill，获取仓库详情和最新提交哈希。
version: 1.0.0
created_at: 2025-01-24
updated_at: 2026-01-26
entry_point: scripts/create_github_skill.py
